...
public final class CalendarOverlay {
    ...
    public static void render(GuiGraphics gfx, Minecraft client, int screenWidth) {
        ...
        gfx.drawCenteredString(client.font, icon, Math.round(cxBox), Math.round(topY), 0xFFFFFFFF);
        gfx.pose().popMatrix();
    }
