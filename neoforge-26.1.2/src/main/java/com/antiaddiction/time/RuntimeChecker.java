...
public class RuntimeChecker {
    ...
    public static void renderCountdownHud(GuiGraphicsExtractor gfx) {
        ...
        gfx.centeredText(client.font, line1, x + client.font.width(line1) / 2, y, 0xFFFFFFFF);
        gfx.centeredText(client.font, line2, x + client.font.width(line2) / 2, y + client.font.lineHeight + 2, 0xFFFFD166);
    }
