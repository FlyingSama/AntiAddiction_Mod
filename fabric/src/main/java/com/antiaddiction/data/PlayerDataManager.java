...
public class PlayerDataManager {
    ...
    private Path getDataPath() {
        return FabricLoader.getInstance().getGameDir()
                .resolve("antiaddiction_data_" + ApiClient.getEnvironmentName() + ".json");
    }
    ...
    private static void addWeekdaysFromArray(java.util.List<Integer> weekdays, JsonArray weekdayArray) {
        for (JsonElement el : weekdayArray) {
            try {
